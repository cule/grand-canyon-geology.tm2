...
// >>>>>>>>>>>>>>>>>>>>>>>>> DEFAULTS = ACCURATE CONTACT <<<<<<<<<<<<<<<<<<<<<<<<<< //
  ...
  [zoom = 11] { line-opacity: 0.25; }
  [zoom < 11] { line-opacity: 0; }

  [fgdc="unknown"],[fgdc="hide"] { line-opacity: 0; }
...
// >>>>>>>>>>>>>>>>>>>>>>>>> FAULTS <<<<<<<<<<<<<<<<<<<<<<<<<< //
  /* Fault (generic; vertical, subvertical, or high-angle; or unknown or
 	...
 	location accurate */
  [fgdc="2.1.1"],[fgdc="2.1.3"],[fgdc="2.1.7"] {
    line-width: @fault-width;
	[zoom = 11] { line-opacity: 0.5; }
    [zoom = 10] { line-opacity: 0.25; }
...
// >>>>>>>>>>>>>>>>>>>>>>>>> NORMAL FAULTS <<<<<<<<<<<<<<<<<<<<<<<<<< //
  ...
  [fgdc="2.2.1"],[fgdc="2.2.3"],[fgdc="2.2.7"] {
    line-width: @fault-width;
    [zoom = 11] { line-opacity: 0.5; }
    [zoom = 10] { line-opacity: 0.25; }
    [zoom < 10] { line-opacity: 0; }
...
// >>>>>>>>>>>>>>>>>>>>>>>>> LOW-ANGLE NORMAL FAULTS <<<<<<<<<<<<<<<<<<<<<<<<<< //
  ...
  [fgdc="2.2.9"],[fgdc="2.2.11"],[fgdc="2.2.15"] {
    line-width: @fault-width;
    [zoom = 11] { line-opacity: 0.5; }
    [zoom = 10] { line-opacity: 0.25; }
    [zoom < 10] { line-opacity: 0; }
...
// >>>>>>>>>>>>>>>>>>>>>>>>> THRUST FAULTS <<<<<<<<<<<<<<<<<<<<<<<<<< //
  ...
  [fgdc="2.8.1"],[fgdc="2.8.3"],[fgdc="2.8.7"] {
    line-width: @fault-width;
    [zoom = 11] { line-opacity: 0.5; }
    [zoom = 10] { line-opacity: 0.25; }
    [zoom < 10] { line-opacity: 0; }
...
// >>>>>>>>>>>>>>>>>>>>>>>>> DETACHMENT FAULTS <<<<<<<<<<<<<<<<<<<<<<<<<< //
  ...
  [fgdc="2.10.1"],[fgdc="2.10.3"],[fgdc="2.10.7"] {
    line-width: @fault-width;
    [zoom = 11] { line-opacity: 0.5; }
    [zoom = 10] { line-opacity: 0.25; }
    [zoom < 10] { line-opacity: 0; }
...
// >>>>>>>>>>>>>>>>>>>>>>>>> LISTRIC FAULTS <<<<<<<<<<<<<<<<<<<<<<<<<< //
  ...
  [fgdc="2.10.33"],[fgdc="2.10.35"],[fgdc="2.10.39"] {
    line-width: @fault-width;
    [zoom = 11] { line-opacity: 0.5; }
    [zoom = 10] { line-opacity: 0.25; }
    [zoom < 10] { line-opacity: 0; }
